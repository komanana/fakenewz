...
class MatrixTableQuestion(models.Model):
    ...
    multipleAnswers = models.BooleanField(default=False)
    otherInput = models.BooleanField(default=False)
    columnConfig = models.TextField(max_length=5000, blank=True, default='[{"label":"Strong disgree","value":"e"},{"label":"Disagree","value":"d"},{"label":"Neutral","value":"c"},{"label":"Agree","value":"b"},{"label":"Strong disagree","value":"a"}]')
