...
describe('The Panel Base test', () => {
    ...
    it('editingBlock currentBlock valid computed test', () => {
        ...
        expect(wrapper.vm.editingBlock).toEqual(wrapper.vm.$props.editorData.blocks[1]);
    ...
    it('editingBlock currentBlock null computed test', () => {
        ...
        expect(wrapper.vm.editingBlock).toEqual(wrapper.vm.$props.editorData.blocks[0]);
    ...
    it('editingQuestion currentQuestion valid computed test', () => {
        ...
        expect(wrapper.vm.editingQuestion).toEqual(wrapper.vm.$props.editorData.blocks[0].questionData.questions[1]);
