<template>
  <div class="out-box">
    <div class="post" >
      <a v-if="question.articleImageLink" :href="question.articleURL" target="_blank"><img :src="question.articleImageLink" :alt="question.articleImageLink" width="200px" height="auto" /></a>
    ...
    <el-row style="margin: 10px;">
      <!--reply-->
      <el-col :style="colWidth" v-show="replyShow" style="text-align: center">
        <div class="clickItem-reply"
             title="Reply">
          <span class="iconfont clickItem-icon-reply" :style="iconColorReply" @click="clickItem('Reply')">&#xe602;</span>
          <span class="clickItem-title-reply" :style="textColorReply">{{ this.questionData.articleComments }}</span>
        </div>
      </el-col>

      <!--retweet-->
      <el-col :style="colWidth" v-show="retweetShow" style="text-align: center">
        <div class="clickItem-retweet"
             :title="retweetTitle">
          <span class="iconfont clickItem-icon-retweet" :style="iconColorRetweet" @click="clickItem('Retweet')">&#xe60b;</span>
      ...
      <!--like-->
      <el-col :style="colWidth" v-show="likeShow" style="text-align: center">
        <div class="clickItem-like"
             :title="likeTitle">
          <span class="iconfont clickItem-icon-like" :style="iconColorLike" @click="clickItem('Like')">&#xe8ab;</span>
          <span class="clickItem-title-like" :style="textColorLike">{{ this.questionData.articleLikes }}</span>
        </div>
      </el-col>

      <!--add1-->
      <el-col :style="colWidth" v-show="addon1Show" style="text-align: center">
      ...
      <!--add2-->
      <el-col :style="colWidth" v-show="addon2Show" style="text-align: center">
