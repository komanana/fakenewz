<template>
  <div class="question-box" :style="color">
    ...
    <PostTwitterReadOnly
        ...
        :question="questionData"></PostTwitterReadOnly>
    <PostFacebookReadOnly
        v-else-if="questionData.articleStyle === 'Facebook' || questionData.articleStyle === 'Reddit' || questionData.articleStyle === 'LinkedIn' || questionData.articleStyle === 'Tumblr' || questionData.articleStyle === 'Pinterest'"
        @updateAnswer = "getData"
