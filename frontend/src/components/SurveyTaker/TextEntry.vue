<template>
  <div class="question-box" :style="color">
    ...
    <span class="tip-box" v-if="this.questionData.validate === true">
      <span v-if="this.questionData.ansType === 'Text'"><span style="color: red">Tips:</span> Please input {{this.questionData.textboxMin}} ~ {{this.questionData.textboxMax}} words!</span>
      <span v-if="this.questionData.ansType === 'Integer'"><span style="color: red">Tips:</span> Please input {{this.questionData.textboxMin}} ~ {{this.questionData.textboxMax}} integers!</span>
      <span v-if="this.questionData.ansType === 'Decimal'"><span style="color: red">Tips:</span> Please input {{this.questionData.textboxMin}} ~ {{this.questionData.textboxMax}} decimals!</span>
    </span>
  </div>
      ...
      if (this.questionData.required === true) {
        if (this.answerText.length != 0 || this.answerDecimal != 0 ) {
          if (this.questionData.validate == true){
            if (this.questionData.ansType === "Text") {
              if (this.answerText.length >= this.questionData.textboxMin && this.answerText.length <= this.questionData.textboxMax) {
            ...
            if (this.questionData.ansType === "Integer") {
              if (this.answerDecimal >= this.questionData.textboxMin && this.answerDecimal <= this.questionData.textboxMax) {
                this.changeColor(true)
                return true
              } else {
                this.changeColor(false)
