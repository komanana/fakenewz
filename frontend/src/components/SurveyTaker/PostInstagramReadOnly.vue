<template>
  <div class="wrapper">
    ...
    <div class="post">
      ...
      <h1><a :href="question.articleURL" style="text-decoration:none; color: black" target="_blank">{{
      question.articleTitle }}</a></h1>
        ...
        <el-row class="count-row">
          <el-col class="count-col" :span="2" v-show="likeShow">
            <el-image class="like-img"
              ...
              v-show="likeShow"><span>&nbsp</span></el-image>
          </el-col>
    ...
    <div class="comment">
      <div v-for="item in question.comments" :key="item.id" class="comment-item">
        <div class="comment-content">
          ...
          <p style="font-size: 14px;padding-top:4px;">{{item.content}}</p>
        </div>
        </div>
