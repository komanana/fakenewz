...
export default {
  ...
  methods: {
    async toggleMinTitleOn(store) {
      ...
      await SurveyServices.patchNumberScale(this.question.id, {minTitleOn: this.question.minTitleOn})
    },
    ...
    async toggleMidTitleOn(store) {
      ...
      await SurveyServices.patchNumberScale(this.question.id, {midTitleOn: this.question.midTitleOn})
    },
    ...
    async toggleMaxTitleOn(store) {
      ...
      await SurveyServices.patchNumberScale(this.question.id, {maxTitleOn: this.question.maxTitleOn})
    },
    ...
    async updateMinNum(value, store) {
      if (value < this.question.maxNum) {
        ...
        await SurveyServices.patchQuestionType(this.question.id, {numberMin: value})
      }
    },
    async incrementMinNum(value, store) {
      if (this.question.minNum <= this.question.maxNum - 1) {
        ...
        await SurveyServices.patchQuestionType(this.question.id, {numberMin: parseInt(this.question.minNum)})
      }
    },
    ...
    async updateMaxNum(value, store) {
      if (value > this.question.minNum) {
        ...
        await SurveyServices.patchQuestionType(this.question.id, {numberMax: value})
      }
    },
    async decrementMaxNum(value, store) {
      if (this.question.maxNum > this.question.minNum + 1) {
        ...
        await SurveyServices.patchQuestionType(this.question.id, {numberMax: parseInt(this.question.maxNum)})
      }
    },
    ...
    async updateIntervalNum(value, store) {
      ...
      await SurveyServices.patchQuestionType(this.question.id, {interval: value})
    },
    async incrementIntervalNum(value, store) {
      ...
      await SurveyServices.patchQuestionType(this.question.id, {interval: parseInt(this.question.interval)})
    },
