...
export default {
  ...
  methods: {
    ...
    async insertNewElement(store) {
      const resp = await SurveyServices.postRankOrderQuestion(this.question.typedata.id,
    ...
    async removeLastElement(store) {
      ...
      await SurveyServices.deleteRankOrderQuestion(this.question.typedata.id, {id: String(temp_id)})
    },
    /**
    ...
    async toggleMultipleAnswers(store) {
      ...
      await SurveyServices.patchMultiChoiceAnswers(this.question.typedata.id, {multipleAnswers: this.question.multipleAnswers, otherInput: this.question.otherInput})
    },
    async toggleMultipleOtherInput(store) {
      ...
      await SurveyServices.patchMultiChoiceAnswers(this.question.typedata.id, {otherInput: this.question.otherInput})
    },
    /**
    ...
    async updateMultiChoiceMinValue(store, flag, value) {
      ...
      await SurveyServices.patchMultiChoiceAnswers(this.question.typedata.id, {textboxMin: this.question.textboxMin})
    },
    /**
    ...
    async updateMultiChoiceMaxValue(store, flag, value) {
      ...
      await SurveyServices.patchMultiChoiceAnswers(this.question.typedata.id, {textboxMax: this.question.textboxMax})
    }
  },
  props: {
    question: Object,
