<template>
  <div>
    <div class="post">
      <a v-if="question.articleImageLink" :href="question.articleURL" target="_blank"><img
          :src="question.articleImageLink" :alt="question.articleImageLink" width="200px" height="auto"/></a>
    ...
    <div class="comment">
      ...
      <div class="type-in">
        <el-input v-model="comment" placeholder="write a comment..."></el-input>
        <button-base
