    ...
    <el-row v-for="(item, index) in icons" :key="index" >
      <el-col v-if="index % 2 == 1" :span="12">
        <el-option  :label="icons[index-1].label" :value="icons[index-1].value">
          <el-link :underline="false" v-bind:icon="icons[index-1].value">{{icons[index-1].label}}</el-link>
        </el-option>
      </el-col>

      <el-col v-if="index % 2 == 1 || (index % 2 == 0 && index == icons.length-1)" :span="12">
        <el-option :label="icons[index].label" :value="icons[index].value">
          <el-link :underline="false" v-bind:icon="icons[index].value">{{icons[index].label}}</el-link>
        </el-option>
      </el-col>
