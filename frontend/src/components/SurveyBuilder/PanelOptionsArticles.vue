<template>
  <div class="options">
    ...
    <dropdown-base
      :options="['Twitter', 'Facebook', 'Youtube','TikTok','Instagram','Reddit','LinkedIn','Pinterest','Tumblr']"
      :icons="['fab fa-twitter', 'fab fa-facebook', 'fab fa-youtube','fab fa-tiktok','fab fa-instagram','fab fa-reddit','fab fa-linkedin','fab fa-pinterest','fab fa-tumblr']"
...
export default {
  ...
  methods: {
    ...
    removeLastComment(){
      ...
      SurveyServices.delComment(this.question.comments[this.question.comments.length-1].id)
    ...
    async insertNewElement(store) {
      ...
      if (this.question.addon.length < 2){
        ...
        await this.$alert('Maximum number of additional field must less than 2', 'Warning', {
