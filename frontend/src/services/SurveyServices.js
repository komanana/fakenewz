...
const cloneSurvey = async (survey_id, user_id) => {
  const response = await axios.post(
    devServer.proxy + `survey/cloneSurvey/${survey_id}/${user_id}`
  )
  return response.data
}
...
const patchMatrixTableQuestion = async (data) => {
  const response = await axios.patch(
    baseUrl + `/questions/patchMatrixTableQuestion`,data
  )
  return response.data
}
const patchSlidersQuestion = async (data) => {
  const response = await axios.patch(
    baseUrl + `/questions/patchSlidersQuestion`,data
  )
  return response.data
}
const patchGroupsQuestion = async (data) => {
  const response = await axios.patch(
    baseUrl + `/questions/patchGroupsQuestion`,data
  )
  return response.data
}
...
const deleteAvatar = async (data) => {
  const response = await axios.delete(
    baseUrl + `/common/avatar?id=${data.id}`,
  )
  return response.data
}
const getAvatar = async (data) => {
  const response = await axios.get(
    baseUrl + `/common/avatar?user=${data.user}`,
  )
  return response.data
}
